...
public class PoliceTracking extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //define buttons
        Button UpdateButton = (Button) v.findViewById(R.id.SaveSettingButton);
        Button SimulateButton = (Button) v.findViewById(R.id.cancelButton);
        ...
        UpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //metropolia leppävaara latitude and longitude
                Lati="60.221781";
                Longi="24.804288";
